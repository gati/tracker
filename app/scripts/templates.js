...
function program1(depth0,data) {
  ...
  stack1 = {};
  hashTypes = {};
  stack1 = helpers.action.call(depth0, "doFestival", "festival", {hash:stack1,contexts:[depth0,depth0],types:["ID","ID"],hashTypes:hashTypes,data:data});
  data.buffer.push(escapeExpression(stack1) + ">");
  stack1 = {};
  hashTypes = {};
  stack1 = helpers._triageMustache.call(depth0, "festival.name", {hash:stack1,contexts:[depth0],types:["ID"],hashTypes:hashTypes,data:data});
  ...
  stack1 = {};
  hashTypes = {};
  stack1 = helpers.each.call(depth0, "festival", "in", "content", {hash:stack1,inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0,depth0,depth0],types:["ID","ID","ID"],hashTypes:hashTypes,data:data});
...
Ember.TEMPLATES["festival"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
